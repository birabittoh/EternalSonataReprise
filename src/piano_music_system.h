// eternalsonata - Piano Music unlock state for mods.
//
// The public C ABI mods call is eternalsonata_piano_music_api.h; this header
// is the small internal surface the rest of the exe needs.
#pragma once
...
// Binds the piano music system to the runtime and starts the per-frame poll
// that publishes the unlock events. Call once the runtime is live
